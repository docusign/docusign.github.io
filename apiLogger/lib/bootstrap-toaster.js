 ...
 * A fork of an open source project. Thank you to the project's authors.
 */

// Forked from https://github.com/PeytonRG/BootstrapToaster/blob/master/js/bootstrap-toaster.js
/**
...
class Toast {
    ...
    static setStatus(toastEl, status) {
        ...
        headerEl.classList.add(TOAST_COLOR_STYLES[status]);
        bodyEl.classList.add(TOAST_COLOR_STYLES[status]);
        switch (status) {
