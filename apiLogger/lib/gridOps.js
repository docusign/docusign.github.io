...
class GridOps {
    ...
    constructor(logger, kustoSettings, columnSettings) {
        this.logger = logger;
    ...
    refresh(kustoSettings, columnSettings) {
        this.kustoSettings = kustoSettings;
        this.columnSettings = columnSettings;
    ...
    buttonViewTheLogEntry(rowKey) {
        ...
        const customBtn = (this.kustoSettings.ver && this.kustoSettings.useCustomSbutton && this.kustoSettings.customBtnLabel) ?
            ...
            `${this.kustoSettings.customBtnLabel}</button>` : "";
    ...
    async buttonCustomCopyToClipboard(event) {
        ...
        if (!rowKey) {return}
        const logEntry = this.logger.lookupByTimestamp(rowKey);
        let template = this.kustoSettings.customTemplate;
...
class ButtonRenderer {
    ...
    render(props) {
        const { gridOps } = props.columnInfo.renderer.options;
        const kustoSettings = gridOps.kustoSettings;
        let buttonLetter, buttonOp;
        if (kustoSettings.ver && kustoSettings.useCustomSbutton) {
            buttonLetter = kustoSettings.customBtnLetter;
            buttonOp = "custom";
        } else {
            buttonLetter = "C";
            buttonOp = "c";
